...
public class Main {
	public static void main(String[] args) {
		...
		linearStretcher.globalStretch("str_global", 256/8*1, 256/8*7);
		linearStretcher.localStretch("str_local", 256/8*3, 256/8*5, 256/8*2, 256/8*6);	// task 2
